...
if __name__ == "__main__":
    ...
    while len(overVoltageList) != len(loadList):  # percorre os elementos (getLoads) e adiciona PV nas cargas enquanto sua tensão é < 1.05 pu
        ...
        print("Multiplicador: ", multwhile)
        createGD2("trf167839-hc", cargasBTList, multwhile, limpar=True)
        solvetrf(alvo)
        loadList, overVoltageList = getLoads(alvo, contadorOvervoltage)  # novo cargaBTList
